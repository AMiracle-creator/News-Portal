            ...
            <div class="posts__content">
                ...
                <div class="posts__item wow fadeInUp">
                    <div class="posts__photo">
                        <a href="#">
                            <img src="img/posts/ph1.jpg" alt="" class="posts__img"></a>
                    </div>
                    <div class="posts__item-content">
                        <p><a href="#" class="posts__title posts__title--underline">How to use your money if you want
                            live in London</a></p>

                        <div class="posts__info">
                            <div class="posts__topic">Travel</div>
                            <div class="posts__date">August, 15 2020</div>
                            <div class="posts__name">Jenny Preston</div>
                            <div class="posts__comments">10 comments</div>
                            <div class="posts__views"> 1000 view</div>
                        </div>

                        <div class="posts__text">Dynamically target high-payoff intellectual capital for customized
                            technologies. Objectively integrate emerging core competencies before process-centric
                            communities.
                        </div>
                        <label class="mb">
