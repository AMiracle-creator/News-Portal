...
<div class="about__intro">
    <div class="about__bg">
        <img src="templates/img/about/title.jpg" alt="" class="about__img">
        ...
        <div class="about__inner">
            ...
            <div class="about__content">
                <div class="about__item-bg">
                    <img src="templates/img/about/post-2-copyright.jpg" alt="" class="item-bg">
                    <div class="about__item-bg-text">New skills that will help and reveal you</div>
                </div>
                <div class="about__items">
                    <div class="about__item-sm">
                        <img src="templates/img/about/photograph.jpg" alt="" class="item-sm">
                        <div class="about__item-sm-text">Worlds you didn't even know existed</div>
                    </div>
                    <div class="about__item-sm">
                        <img src="templates/img/about/machina.jpg" alt="" class="item-sm">
            ...
            <div class="about__content about__content-new">
                <div class="about__item-bg">
                    <img src="templates/img/about/twopeople.jpg" alt="" class="item-bg">
                    <div class="about__item-bg-text">Dating and thoughts with like-minded people</div>
                </div>
                <div class="about__items">
                    <div class="about__item-sm">
                        <img src="templates/img/about/girl.jpg" alt="" class="item-sm">
                        <div class="about__item-sm-text">Eternal and unforgettable stories</div>
                    </div>
                    <div class="about__item-sm">
                        <img src="templates/img/about/meet.jpg" alt="" class="item-sm">
            ...
            <div class="about__video">
                <div class="video__inner">
                    <video class="video" src="templates/img/video/coverr--07-20-friends-at-sunset-25-5167.mp4" muted loop
                           autoplay></video>
                </div>
